...
public class OpportunityDelete {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//input[@type='search'])[2]")).sendKeys("Salesforce Automation by Sudharsanam");
		Thread.sleep(5000);
		...
		Thread.sleep(2000);
		WebElement delete4 = driver.findElement(By.xpath("//a[text()='Salesforce Automation by Sabarinathan']"));
		String text = delete4.getText();
		if (text.equals("Salesforce Automation by Sudharsanam")) {
