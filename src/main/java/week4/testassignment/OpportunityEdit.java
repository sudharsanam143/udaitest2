...
public class OpportunityEdit {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name='Opportunity-search-input']")).sendKeys("Salesforce Automation by Sudharsanam  ");
		Thread.sleep(5000);
		...
		WebElement element4 = driver.findElement(By.xpath("(//button[@data-value='--None--'])[3]"));
